...
from recipes.models import Tag, Ingredient, Recipe, TagRecipe, IngredientRecipe, Favorite
...
class RecipeConfig(admin.ModelAdmin):
    ...
    list_display = ["id", "author", "name", "text", "get_ingredients", "get_tags", "image", "cooking_time", "count_favorites"]
