...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            ...
            options={'ordering': ('id',), 'verbose_name': 'Связь рецепта и ингредиента', 'verbose_name_plural': 'Связи рецептов и ингредиентов'},
        ),
        migrations.AlterModelOptions(
            name='tagrecipe',
            options={'ordering': ('id',), 'verbose_name': 'Связь рецепта и тега', 'verbose_name_plural': 'Связи рецептов и тегов'},
        ),
